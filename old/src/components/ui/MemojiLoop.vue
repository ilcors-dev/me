<template>
	<img
		:src="logo"
		class="h-[128px] w-[128px] object-cover transition-all duration-500 ease-in-out sm:h-[172px] sm:w-[172px]"
	/>
</template>
...
const logo = ref(memojis[0]);

setInterval(() => {
	logo.value = memojis[Math.floor(Math.random() * memojis.length)];
}, 2000);
</script>
