...
export class Universe {
    ...
    * @returns {Universe}
    */
    static new(width, height, cell_size, canvas_id) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.universe_new(width, height, cell_size, ptr0, len0);
    ...
    */
    render(dead_color_hex, alive_color_hex) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(dead_color_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(alive_color_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.universe_render(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
